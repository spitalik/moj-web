...
const ASSETS = [
  ...
  './fonts/dmsans-var-latin-ext.woff2',
  './fonts/dmsans-var-latin.woff2',
  './fonts/syne-var-latin-ext.woff2',
  './fonts/syne-var-latin.woff2',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
